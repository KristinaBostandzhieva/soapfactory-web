    ...
    <div className="max-w-[700px] mx-auto px-[15px] py-24 text-center">
      ...
      {order && (
        <p className="text-[var(--text-body)] mb-2">
          Номер на поръчката: <strong>#{orderNumber(order.id)}</strong>
        </p>
      )}
      <p className="text-[var(--text-body)] mb-6">
        {paid
          ? 'Плащането е получено успешно. Ще те уведомим с имейл при изпращане.'
          : 'Потвърждаваме плащането ти. Ако плащането е завършено, ще получиш потвърждение.'}
      </p>
