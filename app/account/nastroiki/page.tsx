...
export default function AccountSettingsPage() {
  ...
  return (
    <div className="account-settings-page">
      ...
      />
      <div className="account-form-shell max-w-[600px] mx-auto px-[15px] py-12">
        <form onSubmit={submit} className="account-form-card bg-[var(--bg-light)] rounded-md p-8">
          ...
          <div className="account-form-row grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="account-form-links mt-6 flex flex-col gap-3">
